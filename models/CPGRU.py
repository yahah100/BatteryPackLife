...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.inter_cycle_GRU = nn.GRU(configs.d_model, configs.d_ff, configs.lstm_layers, batch_first=True, dropout=self.drop_rate, bidirectional=False)
    ...
    def classification(self, x_enc, curve_attn_mask, return_embedding=False):
        ...
        x_enc, _ = self.inter_cycle_GRU(x_enc)
