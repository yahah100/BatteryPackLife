...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.BiLSTM = nn.LSTM(configs.d_model, configs.d_ff, configs.lstm_layers, batch_first=True, dropout=self.drop_rate, bidirectional=True)
